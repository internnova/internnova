...
export default function ContactUs() {
  ...
  return (
    <section
      className="pt-12 bg-gray-100 pb-7 lg:pt-16 xl:pt-28"
      id="ContactUs"
    >
        ...
        <div className="grid gap-6 lg:gap-10 xl:grid-cols-3 mb-7 lg:mb-14">
          <div className="flex flex-col justify-between space-y-10 xl:space-y-0">
            <div className="space-y-2 lg:space-y-4">
              ...
              <a
                href="#0"
                className="block text-blue-500 transition  duration200 hover:text-blue-600 md:text-lg"
              >
                +91 96062 14954
              </a>
              <a
          ...
          <div className="xl:col-span-2">
            <form className="w-full p-5 bg-white shadow rounded-xl md:p-8">
