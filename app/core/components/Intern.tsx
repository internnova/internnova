...
export const Intern = ({ intern }) => {
  return (
    <>
      ...
      {/*   <a className="flex md:flex-row flex-col md:gap-6 text-gray-800 rounded-md hover:bg-gray-100 shadow-lg w-[300px] p-[2em] border-solid border-[1px] border-gray-300"> */}
      ...
      {/*   </a> */}
      {/* </Link> */}
      <div className="bg-white flex flex-col text-gray-800 rounded-md hover:bg-gray-100 shadow-lg w-[300px] p-[2em] border-solid border-[1px] border-gray-300">
        <div className="flex flex-row gap-6">
          ...
          <div>
            <h2 className="font-[600] truncate md:text-lg leading-[1.1]">{intern.user.name}</h2>
            <p className="truncate tracking-[1px] text-sm text-primary">@{intern.user.username}</p>
          </div>
        </div>
