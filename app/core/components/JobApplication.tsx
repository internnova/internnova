...
export const JobApplication = ({
  ...
  return (
    <div className="relative flex bg-white hover:bg-gray-50 rounded-md shadow-md py-4 px-2">
      <div className="flex w-full">
        ...
        <div className="flex flex-col">
          ...
          <div className="flex gap-4">
            ...
            <p className="text-gray-500">Applied at: {new Date(createdAt).toLocaleDateString()}</p>
          </div>
        </div>
        <Link href={`/job-applications/${companyName}/${slug}/edit`}>
