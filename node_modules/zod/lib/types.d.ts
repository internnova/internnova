...
export declare class ZodString extends ZodType<string, ZodStringDef> {
    ...
    cuid: (message?: errorUtil.ErrMessage | undefined) => ZodString;
...
export interface ZodTupleDef<T extends ZodTupleItems | [] = ZodTupleItems> extends ZodTypeDef {
    items: T;
...
export declare class ZodEffects<T extends ZodTypeAny, Output = T["_type"]> extends ZodType<Output, ZodEffectsDef<T>, T["_input"]> {
    ...
    static createWithPreprocess: <I extends ZodTypeAny>(preprocess: (arg: unknown) => unknown, schema: I) => ZodEffects<I, I["_output"]>;
}
...
declare const preprocessType: <I extends ZodTypeAny>(preprocess: (arg: unknown) => unknown, schema: I) => ZodEffects<I, I["_output"]>;
